...
\addassoc\@globalenv\mdefine{\@tlabel@mdefine{}}
...
%   {\gdef#1{}%
%   \@flatten@list#1#5{#6}%
%   \expandafter\@@extern@apply\expandafter{#1}#1{#2}#3{#4}}}
% \def\@@extern@apply#1#2#3#4#5{% fargs, reg, env, label, cont
%   \ifx#4\Func
%     \@apply@func#4{#5}{#1}{#3}#2%
%   \else\ifx#4\EnvFunc
%     \@apply@envfunc#4{#5}{#1}{#3}#2%
%   \else\ifx#4\Closure
%     \@apply@closure#4{#5}{#1}{#3}#2%
%   \else\ifx#4\Macro
%     \@apply@macro#4{#5}{#1}{#3}#2%
%   \fi\fi\fi\fi}
