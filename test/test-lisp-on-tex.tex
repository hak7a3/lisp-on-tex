  ...
  \begin{qstest}{Fundamental Eval Test}{\@lispeval}
   ...
   \begin{qstest}{special forms}{\@lispeval}
    ...
    \testEvalWithSExp{\@test@define@one}
      {\@tlabel@int{42}}
    \testEvalWithSExp{(\@let \@foo :1 (\define \@test@fail 'invalid'))}
      {\@tlabel@exception{{-1}{Sorry. Currently, \string\define cannot be used in local environment }}}
    \testEvalWithSExp{((\lambda ()(\define \@test@fail 'invalid')))}
      {\@tlabel@exception{{-1}{Sorry. Currently, \string\define cannot be used in local environment }}}
    %defineM
    \toks0\expandafter{\@globalenv}
    ...
    \expandafter\checkDefineMutableCheckEnv\@globalenv\@@end
    \testEvalWithSExp{(\begin (\defineM \@test@define@one :42) \@test@defineM@one)}
      {\@tlabel@int{42}}
    \testEvalWithSExp{\@test@defineM@one}
      {\@tlabel@int{42}}
    \testEvalWithSExp{(\@let \@foo :1 (\defineM \@test@fail 'invalid'))}
      {\@tlabel@exception{{-1}{Sorry. Currently, \string\defineM cannot be used in local environment }}}
    \testEvalWithSExp{((\lambda ()(\define \@test@fail 'invalid')))}
      {\@tlabel@exception{{-1}{Sorry. Currently, \string\defineM cannot be used in local environment }}}
    %setB
    \lispinterp{
    ...
    \testEvalWithSExp{(\let ((\unbound 'invalid')) (\setB \@valtest (\testLocalness)))}
      {\@tlabel@exception{{-1}{unbound variable \string\unbound}}}
